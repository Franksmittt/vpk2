...
export const metadata: Metadata = {
  ...
  description:
    "Four kraals on camp. Vark Kraal bar. Full board. Pool, canopy boma, outlook, waterhole. Iron Mountain aircon nights. P3, safes, cold room, field butchery. Matlabas on the gate.",
};
...
function Pic({
  ...
  const url = src ?? `https://picsum.photos/seed/${seed}/1600/1050`;
  return (
    <Image
      src={url}
      alt={alt}
...
const LodgePage = () => {
  return (
    <div className="min-h-screen bg-black text-white">
      <PageHero
        heroTitleId="lodge-hero-title"
        scrollLinkedTypography
        eyebrow="The Lodge"
        title="Four kraals. One camp pulse."
        subtitle={`Sleep in ${CHALET_KRAALS_LINE}: the only beds on the hunt camp. Drink and eat at ${COMMUNAL_BAR_KRAAL}. Pool, canopy boma, outlook, waterhole. Full board. Clay or a drive when the day loosens. Facts first: for you, for agents, for management.`}
      ...
      <section className="relative overflow-hidden border-b border-white/[0.07] bg-[#030303]">
        ...
        <div className="editorial-container-wide relative pb-20 pt-14 md:pb-28 md:pt-20">
          ...
          <div className="flex flex-col gap-2 sm:gap-3">
            <div className="grid grid-cols-2 gap-2 sm:gap-3 lg:min-h-[min(52vh,460px)] lg:grid-cols-12 lg:grid-rows-2 lg:gap-4">
              <div className="group relative col-span-2 aspect-[4/5] overflow-hidden rounded-[1.25rem] ring-1 ring-white/[0.1] sm:rounded-2xl lg:col-span-7 lg:row-span-2 lg:aspect-auto lg:min-h-0">
                <Image
                  src={`${LODGE}/brochure-hero.jpg`}
                  alt="Vaalpenskraal chalets and camp buildings from the approach road"
                  fill
                  sizes="(max-width: 1024px) 100vw, 50vw"
                  className="object-cover transition duration-[1.25s] ease-out group-hover:scale-[1.04]"
                  priority
                />
                <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/65 via-black/10 to-black/30" aria-hidden />
              </div>
              <div className="group relative aspect-[16/11] overflow-hidden rounded-[1.25rem] ring-1 ring-white/[0.1] sm:rounded-2xl lg:col-span-5 lg:min-h-0">
                <Image
                  src={`${LODGE}/brochure-bar.jpg`}
                  alt={`${COMMUNAL_BAR_KRAAL} communal bar and lounge interior`}
                  fill
                  sizes="(max-width: 1024px) 100vw, 50vw"
                  className="object-cover transition duration-[1.25s] ease-out group-hover:scale-[1.04]"
                  priority
              ...
              <div className="group relative aspect-[16/11] overflow-hidden rounded-[1.25rem] ring-1 ring-white/[0.1] sm:rounded-2xl lg:col-span-5 lg:min-h-0">
                <Image
                  ...
                  alt="Swimming pool at Vaalpenskraal with chalets and lapa in the background"
                  fill
                  sizes="(max-width: 1024px) 100vw, 50vw"
                  className="object-cover transition duration-[1.25s] ease-out group-hover:scale-[1.04]"
                />
            ...
            <div className="group relative aspect-[21/10] overflow-hidden rounded-[1.25rem] ring-1 ring-white/[0.1] sm:rounded-2xl lg:aspect-[3/1]">
              <Image
                ...
                alt="Panoramic view of Vaalpenskraal gate, camp, and Waterberg bushveld"
                fill
                sizes="100vw"
                className="object-cover transition duration-[1.25s] ease-out group-hover:scale-[1.03]"
              />
            ...
            <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-2xl [perspective:1400px]">
                ...
                <div className="mt-4 flex flex-wrap items-baseline gap-x-4 gap-y-2">
                  <h2 className="vp-scroll-reveal-type font-serif text-3xl font-normal tracking-[-0.02em] text-white sm:text-4xl md:text-[2.65rem] md:leading-[1.1]">
                    Property snapshot
                  </h2>
              ...
              <Link
                ...
                className="focus-ring-invert inline-flex shrink-0 items-center gap-2 self-start rounded-full bg-white px-6 py-3 font-sans text-xs font-semibold uppercase tracking-[0.18em] text-black transition hover:bg-white/90 lg:self-end"
              >
                Enquire dates
        ...
        <div className="editorial-container">
          <div className="grid gap-12 lg:grid-cols-12 lg:items-center lg:gap-16">
            <div className="lg:col-span-5">
              <p className="font-sans text-[11px] font-medium uppercase tracking-[0.3em] text-white/70">Through a guest&apos;s eyes</p>
      ...
      <section className="border-b border-white/[0.07] bg-[#050505] py-20 md:py-32">
        <div className="editorial-container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 font-sans text-[11px] font-medium uppercase tracking-[0.3em] text-white/70">Accommodation</p>
          ...
          <div className="mt-14 grid gap-6 lg:grid-cols-12 lg:gap-8">
            <div className="flex flex-col justify-center rounded-2xl border border-white/[0.08] bg-white/[0.02] p-6 md:p-8 lg:col-span-4">
              <div className="flex items-start gap-3">
                <Bath className="mt-1 h-6 w-6 shrink-0 text-burnished-copper/75" aria-hidden />
                <div>
                  ...
                  <p className="mt-2 font-sans text-sm leading-relaxed text-white/65">
                    Showers, <strong className="font-medium text-white/75">two basins</strong>, and <strong className="font-medium text-white/75">toilet</strong> per chalet. Enough elbow room for two people getting ready while a third still packs a daypack.
                  </p>
                </div>
              </div>
              <div className="mt-8 flex items-start gap-3 border-t border-white/[0.08] pt-8">
                <Fan className="mt-1 h-6 w-6 shrink-0 text-burnished-copper/75" aria-hidden />
                <div>
              ...
              <div className="mt-8 flex items-start gap-3 border-t border-white/[0.08] pt-8">
                <BedDouble className="mt-1 h-6 w-6 shrink-0 text-burnished-copper/75" aria-hidden />
                <div>
        ...
        <div className="editorial-container">
          <div className="grid gap-12 lg:grid-cols-12 lg:items-center lg:gap-16">
            <div className="lg:col-span-5">
              ...
              <p className="mt-6 font-sans text-[11px] font-medium uppercase tracking-[0.3em] text-white/70">Communal space</p>
      ...
      <section className="border-b border-white/[0.07] bg-neutral-950 py-20 md:py-28">
        <div className="editorial-container">
          <div className="grid gap-10 lg:grid-cols-12 lg:items-center lg:gap-16">
            <figure className="order-2 overflow-hidden rounded-2xl ring-1 ring-white/[0.08] lg:order-1 lg:col-span-7">
              <Pic
            ...
            <div className="order-1 lg:order-2 lg:col-span-5">
              ...
              <p className="mt-6 font-sans text-[11px] font-medium uppercase tracking-[0.3em] text-white/70">Fully catered</p>
      ...
      <section className="border-b border-white/[0.07] py-20 md:py-32">
        <div className="editorial-container">
          <p className="text-center font-sans text-[11px] font-medium uppercase tracking-[0.3em] text-white/70">Outdoor living</p>
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-2">
            ...
            <article className="overflow-hidden rounded-2xl border border-white/[0.08] bg-black/30">
              ...
              <div className="p-5 md:p-6">
                ...
                <p className="mt-2 font-sans text-sm leading-relaxed text-white/65">
                  Outdoor fire and social space <strong className="font-medium text-white/75">under the trees</strong>, with <strong className="font-medium text-white/75">canopy</strong> cover. This is the chapter guests photograph least and remember longest.
                </p>
              </div>
            </article>
          </div>
      ...
      <section className="border-b border-white/[0.07] bg-[#050505] py-20 md:py-32">
        <div className="editorial-container">
          <p className="text-center font-sans text-[11px] font-medium uppercase tracking-[0.3em] text-white/70">Slow hours</p>
        ...
        <div className="editorial-container">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-white/[0.02] p-6 md:p-7">
              ...
              <p className="mt-3 font-sans text-sm leading-relaxed text-white/65">
                <strong className="font-medium text-white/75">Professional slaughtering</strong>, <strong className="font-medium text-white/75">salting of hides</strong>, and <strong className="font-medium text-white/75">carcass weighing</strong> keep the harvest disciplined. Discuss timing and species with camp when you build your hunt plan so crews and equipment are lined up.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="editorial-container">
          <div className="grid gap-12 lg:grid-cols-12 lg:items-center lg:gap-16">
            <div className="lg:col-span-5">
              ...
              <p className="mt-6 font-sans text-[11px] font-medium uppercase tracking-[0.3em] text-white/70">International &amp; trophy hunters</p>
        ...
        <div className="editorial-container grid gap-10 lg:grid-cols-2 lg:items-start lg:gap-16">
          ...
          <div className="rounded-2xl border border-white/[0.08] bg-white/[0.02] p-6 md:p-8">
            <div className="flex items-center gap-3">
              ...
              <KeyRound className="h-7 w-7 text-white/60" aria-hidden />
            </div>
      ...
      <section className="py-20 md:py-32">
        <div className="editorial-container">
          <p className="text-center font-sans text-[11px] font-medium uppercase tracking-[0.3em] text-white/70">Same camp, different trips</p>
