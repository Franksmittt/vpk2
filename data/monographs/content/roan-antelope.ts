...
export function roanAntelopeMonograph(s: QuarrySpecies): MonographDefinition {
  return {
    ...
    imageSeeds: monoSeeds(s, true, {
      heroLocalBase: "/images/species/roan-antelope",
      heroLocalExt: "jpg",
      introLocalBase: "/images/species/roan-antelope",
      introLocalExt: "jpg",
      hornsLocalBase: "/images/species/roan-antelope",
      hornsLocalExt: "jpg",
      formPrimaryLocalBase: "/images/species/roan-antelope",
      formPrimaryLocalExt: "jpg",
      formSecondaryLocalBase: "/images/species/roan-antelope",
      formSecondaryLocalExt: "jpg",
      panoramaLocalBase: "/images/species/roan-antelope",
      panoramaLocalExt: "jpg",
      feedWideLocalBase: "/images/species/roan-antelope",
      feedWideLocalExt: "jpg",
      ecologyLocalBase: "/images/species/roan-antelope",
      ecologyLocalExt: "jpg",
      predationLocalBase: "/images/species/roan-antelope",
      predationLocalExt: "jpg",
      rutLeftLocalBase: "/images/species/roan-antelope",
      rutLeftLocalExt: "jpg",
      huntLocalBase: "/images/species/roan-antelope",
      huntLocalExt: "jpg",
      trophyLocalBase: "/images/species/roan-antelope",
      trophyLocalExt: "jpg",
      rifleLocalBase: "/images/species/roan-antelope",
      rifleLocalExt: "jpg",
    }),
    introPanoramaCaption:
      "Open sweep, thicket margin, or mask flash where the grass thins.",
  };
}
