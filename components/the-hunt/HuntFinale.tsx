      ...
      <div className="editorial-container relative z-10 text-center">
        <div className="mx-auto max-w-3xl rounded-[1.75rem] border border-white/[0.1] bg-black/45 px-7 py-10 shadow-[0_24px_80px_rgb(0_0_0/0.5)] backdrop-blur-sm sm:px-10 sm:py-12 md:px-12 md:py-14">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:flex-wrap">
            <Link
              href="/species"
              className="focus-ring-invert inline-flex items-center gap-2 rounded-full bg-white px-8 py-4 font-sans text-sm font-medium text-black shadow-[0_4px_24px_rgb(0_0_0/0.4)] transition-colors hover:bg-white/90"
            >
            ...
            <Link
              ...
              className="focus-ring-invert inline-flex items-center gap-2 rounded-full border border-white/30 px-8 py-4 font-sans text-sm font-medium text-white transition-colors hover:border-white/50 hover:bg-white/[0.06]"
            >
            ...
            <Link
              href="/experience"
              className="focus-ring-invert inline-flex items-center gap-2 font-sans text-sm text-white/80 transition-colors hover:text-white [text-shadow:0_1px_8px_rgb(0_0_0/0.8)]"
            >
              The Experience
              <ChevronRight className="h-4 w-4 opacity-60" aria-hidden />
            </Link>
